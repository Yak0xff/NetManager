...
static NSString *const DEFAULT_DB_NAME = @"Rcache.sqlite";
...
+(instancetype)sharedYTK {
    static YTKKeyValueStore* sharedYTK = nil;
    @synchronized(self) {
        if (sharedYTK == nil)
            sharedYTK = [[self alloc] initDBWithName:DEFAULT_DB_NAME];
    }
    return sharedYTK;
}
